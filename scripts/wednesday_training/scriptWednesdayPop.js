        ...
        exerciseToDom: function (obj, objID, dates) {
            ...
            switch (obj.exerciseName) {
                ...
                case 'Chest fly':
                    curImg = 'chest_fly';
                    break;
                case 'Chest over head':
                    curImg = 'chest_overHead';
                    break;
                case 'Lats':
                    curImg = 'lats';
                    break;
                case 'Shoulder side raise':
                    curImg = 'shoulder_sideRaise';
                    break;
                case 'Triceps row bar':
                    curImg = 'triceps_row_bar';
                    break;
                case 'Leg curls':
                    curImg = 'curls';
                    break;
                case 'Leg extension':
                    curImg = 'leg_extensions';
                    break;
                case 'Calf raises':
                    curImg = 'calf_raise';
                    break;
            ...
            <!-- **************************************** exercise  *********************************************-->
                                    <div class="exercise__new" id=${objID}>
                                        ...
                                        <div class="exercise__img" style="background-image: url(../image/wednesday/${curImg}.jpg)"></div>
